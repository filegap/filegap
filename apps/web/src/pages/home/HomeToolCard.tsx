...
export function HomeToolCard({ name, description, href, ctaLabel, icon }: HomeToolCardProps) {
  return (
    <a
      href={href}
      className={`${cardStyles({ variant: 'interactive' })} group p-6 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary/30 focus-visible:ring-offset-2`}
    >
      <div className='flex items-start gap-4'>
        ...
        <div className='min-w-0'>
          ...
          <p className='mt-6 inline-flex items-center rounded-lg border border-ui-border bg-ui-bg px-4 py-2 text-sm font-semibold text-ui-text shadow-[0_1px_2px_rgba(15,23,42,0.02)]'>
            <span>{ctaLabel}</span>
            <ArrowRight
